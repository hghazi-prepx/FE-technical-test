...
import { setFormData } from "@/store/customizer/examFormSlice";
...
export default function CreateIMockExam() {
  ...
  const getValidationSchema = (
    ...
    return yup.object().shape({
      ...
      SelectedExamCourse: yup.object().required("Exam course is required"),
  ...
  const handleChangeDropDown = (event: any) => {
    ...
    formik.setFieldValue("ExamType", event);
  };
  ...
  const handleChangeExamCourseDropDown = (value: any) => {
    ...
    if (!createCourseArray || createCourseArray.length == 0) {
      ...
      formik.setFieldValue("SelectedExamCourse", selectedCourseIds?.[0]);
    }
  };
              ...
              <Stack>
                <Box>
                  ...
                  <Autocomplete
                    ...
                    value={formik.values.SelectedExamCourse}
                    autoHighlight
                    ...
                    onChange={(event, value) => {
                      handleChangeExamCourseDropDown(value ?? null);
                    }}
                    renderInput={(params) => (
                      <CustomTextField
                        {...params}
              ...
              >
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DesktopDatePicker
                    ...
                    value={formik?.values?.ExamAvailabilityDate}
                ...
                >
                  ...
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DesktopDatePicker
                      label={null}
                      inputFormat="YYYY/MM/DD"
                      value={formik?.values?.ExamDueDate}
